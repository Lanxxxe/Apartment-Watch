...
<!-- Edit Apartment -->
<div class="modal fade" id="editapartment" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Update Apartment</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
        <form action="./model/editApartment.php" method="POST">
            <div class="modal-body">

                <input class="form-control" type="text" name="AdminID" value="<?php echo $_SESSION['user_id'] ?>" hidden>
                <input class="form-control" type="text" id="apartmentID" name="ApartmentID" hidden>
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="StreetAddress" id="StAddress">
                    <label for="floatingInput">Street Address</label>
                </div>
